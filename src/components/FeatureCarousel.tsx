...
const features = [
  {
    ...
    description: 'Crie e gerencie eventos com poucos cliques',
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Controle confirmações em tempo real',
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Visualize estatísticas e insights',
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Lembretes para você e seus convidados',
  },
];
