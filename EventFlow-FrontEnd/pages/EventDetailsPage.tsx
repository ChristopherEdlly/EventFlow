...
import GuestStatsDashboard from '../components/GuestStatsDashboard';
...
export default function EventDetailsPage({ eventId, onBack }: EventDetailsPageProps) {
  ...
  const [stateChangeDialog, setStateChangeDialog] = useState<{ newState: EventState } | null>(null);
  ...
  const handleChangeState = async () => {
    ...
    try {
      await eventsService.updateEvent(event.id, {
        state: stateChangeDialog.newState,
      });
          ...
          <div className="p-8">
            ...
            {guests.length > 0 && (
              <div className="mt-8 pt-8 border-t border-neutral-200">
                ...
                <GuestStatsDashboard guests={guests} />
