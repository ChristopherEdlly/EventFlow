...
import { eventsService, type Event, type EventState } from '../services/events';
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
          ...
          <div className="mb-6 flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex bg-white border border-neutral-300 rounded-lg p-1">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-md transition-colors ${viewMode === 'calendar' ? 'bg-primary-100 text-primary-700' : 'text-neutral-600 hover:text-neutral-900'}`}
        ...
        {isLoading ? (
          ...
          <EventCalendar events={filteredEvents} onEventClick={(id) => onViewEvent && onViewEvent(id)} />
