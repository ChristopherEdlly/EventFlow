        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-neutral-900">Histórico de Eventos</h1>
                <p className="text-xs text-neutral-500">Eventos concluídos, cancelados e arquivados</p>
              </div>
            </div>
          </div>
        </div>
