  ...
  return (
    <div>
      ...
      <div className="relative rounded-3xl overflow-hidden mb-8 shadow-xl">
        {/* Background: Imagem customizada ou gradiente padrão */}
        {event.imageUrl ? (
          <>
            <img 
              src={event.imageUrl} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            {event.location ? (
              <a 
                ...
                className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-200 cursor-pointer group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-white/70 text-xs font-medium uppercase tracking-wide flex items-center gap-1">
                      Local
                      <svg className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                      </svg>
                    </p>
                    <p className="text-white font-semibold mt-1 truncate group-hover:underline" title={event.location}>
                      {event.location}
                    </p>
                    <p className="text-white/60 text-xs mt-0.5">Clique para ver no mapa</p>
                  </div>
                </div>
              </a>
            ) : (
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white font-semibold mt-1 truncate">A definir</p>
                  </div>
                </div>
              </div>
            )}
